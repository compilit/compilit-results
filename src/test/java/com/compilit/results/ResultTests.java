...
import static com.compilit.results.Message.MESSAGE_FORMAT_ERROR;
import static com.compilit.results.Message.NOTHING_TO_REPORT;
...
class ResultTests {
  ...
  void getResultStatus_shouldReturnResultStatus() {
    ...
    Assertions.assertThat(Result.errorOccurred(TestValue.TEST_MESSAGE).getResultStatus())
  ...
  void getOptionalContents_shouldReturnContentsAsOptional() {
    var result = Result.success(TestValue.TEST_CONTENT);
    Assertions.assertThat(result.getOptionalContents()).contains(TestValue.TEST_CONTENT);
  }

  @Test
  void getContents_shouldReturnContents() {
    var result = Result.success(TestValue.TEST_CONTENT);
    Assertions.assertThat(result.getContents()).isEqualTo(TestValue.TEST_CONTENT);
  }
